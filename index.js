/* player_config // настройки игрока, для отображение элементов интерфейса и выбора параметров player_state. Выводится из обычного config в config_loader.playerConfig
{
	...
	"rows": {
	  "7": {
		"count": 7,
		"low_risk": [2, 1.6, 1.1, 0.7, 0.7, 1.1, 1.6, 2],
		"medium_risk": [3, 2.2, 1.2, 0.5, 0.5, 1.2, 2.2, 3],
		"high_risk": [5, 2.9, 1.2, 0.3, 0.3, 1.2, 2.9, 5]
	  },
	  "9": {
		"count": 9,
		"low_risk": [2.4, 2, 1.5, 1.1, 0.6, 0.6, 1.1, 1.5, 2, 2.4],
		"medium_risk": [4, 3, 1.9, 1.1, 0.4, 0.4, 1.1, 1.9, 3, 4],
		"high_risk": [6, 4, 2.2, 1, 0.3, 0.3, 1, 2.2, 4, 6]
	  },
	  "12": {
		"count": 12,
		"low_risk": [9, 6, 3, 1.9, 1.1, 0.6, 0.4, 0.6, 1.1, 1.9, 3, 6, 9],
		"medium_risk": [20, 11, 4, 2.3, 1, 0.5, 0.2, 0.5, 1, 2.3, 4, 11, 20],
		"high_risk": [47, 20, 6, 2.5, 0.8, 0.3, 0.1, 0.3, 0.8, 2.5, 6, 20, 47]
	  },
	  "15": {
		"count": 15,
		"low_risk": [15, 9, 6, 4, 2.2, 1.3, 0.7, 0.4, 0.4, 0.7, 1.3, 2.2, 4, 6, 9, 15],
		"medium_risk": [42, 21, 10, 5, 2.6, 1.3, 0.5, 0.3, 0.3, 0.5, 1.3, 2.6, 5, 10, 21, 42],
		"high_risk": [145, 53, 20, 7, 2.8, 1.1, 0.3, 0.1, 0.1, 0.3, 1.1, 2.8, 7, 20, 53, 145]
	  }
	},
